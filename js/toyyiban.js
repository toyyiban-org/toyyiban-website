...
customElements.define('t-header', class extends XElement {
	_create() {
		this.innerHTML = `<header class="flex-row g bg p items-center raised-sm">
        <a href="/"><img src="/img/logo.svg" style="width:6rem; min-width:6rem; max-width:6rem"/></a>
        <div class="grow text-xl text-center">Toyyiban Muslim Product Supplies</div>
...
customElements.define('t-footer', class extends XElement {
	_create() {
		...
		<p class="whitespace-nowrap">© 2023-${new Date().getFullYear()} toyyiban.com</p>
